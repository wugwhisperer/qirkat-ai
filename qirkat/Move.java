...
class Move {
    ...
    static Move move(Move move0, Move move1) {
        ...
        if (move0.isVestigial()) {
            if (move1.jumpTail() == null) {
                return move(move0.col0(), move0.row0(),
                        move1.col1(), move1.row1(), move1.jumpTail());
            } else {
                return move1;
            }
        }
        if (move0.jumpTail() == null) {
            if (move1.jumpTail() == null) {
                return move(move0.col0(), move0.row0(),
                        move1.col0(), move1.row0(),
                        move(move1.col0(), move1.row0(),
    ...
    private void toString(Formatter out) {
        String outString = "";
        outString += Character.toString(_col0) + Character.toString(_row0);
        if (_nextJump != null) {
            outString += "-" + _nextJump.toString();
        } else {
            outString += "-" + Character.toString(_col1)
                    + Character.toString(_row1);
        }
